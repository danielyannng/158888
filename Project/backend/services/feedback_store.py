...
# Allow overriding DB path via environment variable (for sandbox compatibility)
import os as _os
if _os.environ.get("FEEDBACK_DB_PATH"):
    DB_PATH = Path(_os.environ["FEEDBACK_DB_PATH"])
...
def clear_feedback() -> None:
    try:
        ...
        pass  # DB may be locked from previous run; ignore on startup
